...
const tools = {
    ...
    trailer: [
        ...
        },
        {
            ...
            action: () => openModalText("Change trailer license", "New License Plate")
        },
        {
    ...
    settings: [
        {
            ...
            action: () => openModalMulti("Choose Color Theme", [
                {
                    type: "dropdown",
                    id: "theme",
                    label: "Theme",
        ...
        },
        {
            ...
            action: () => openModalNumber("Convoy Size", window.baseConfig?.max_convoy_size || 8)
        },
        {
            title: "Language",
